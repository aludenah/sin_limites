...
function specialHistoryContent(course){
  ...
  if(course.id===12&&state.activeTopicIndex===0)return `<section class="bg-white rounded-3xl border border-slate-200 p-6 sm:p-8"><p class="text-xs font-bold uppercase tracking-wider text-red-600">Capítulo 1 de 40 · Presentación interactiva</p><h2 class="mt-3 text-3xl font-black text-blue-950">La ciencia histórica</h2><p class="mt-4 text-slate-600">El contenido del capítulo del libro, reorganizado en diapositivas: concepto e importancia, tiempo histórico, protagonistas, fuentes, ciencias auxiliares, historiografía y periodización.</p><p class="mt-3 text-sm text-slate-500">33 diapositivas · explicaciones ampliadas · 7 actividades con solución · avance guardado</p><a href="historia-universal-capitulo-01.html" class="inline-flex mt-6 rounded-xl bg-blue-950 px-5 py-3 text-sm font-bold text-white">Abrir presentación →</a></section>`;
...
function renderCourse(){
  ...
  const syllabusNote=course.id===12?'<p class="mt-3 text-sm text-slate-500">Temario de referencia: Historia Universal · Lumbreras. 40 capítulos; contenido desarrollado del 1 al 6.</p>':'';
