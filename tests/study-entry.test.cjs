...
const appFiles=['courses.js','history-catalog.js','peru-catalog.js','lenguaje-catalog.js','history-progress.js','app.js'];
...
async function test(){
 ...
 assert.deepEqual(direct.redirects,['index.html?chapter=historia-universal-capitulo-01&v=20260918-language1']);
 ...
 entry.run("selectStudyMode('progressive')");assert.deepEqual(entry.redirects,['historia-universal-capitulo-01.html?v=20260918-language1']);
