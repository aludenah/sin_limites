...
async function test(){
 ...
 assert.deepEqual(direct.redirects,['index.html?chapter=historia-universal-capitulo-01&v=20260918-social1']);
 ...
 entry.run("selectStudyMode('progressive')");assert.deepEqual(entry.redirects,['historia-universal-capitulo-01.html?v=20260918-social1']);
