  ...
  "blocks": [
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Reconstruir",
          "text": "Explicar cómo conocemos un pasado que ya no podemos observar directamente.",
          "tag": "01",
          "icon": "search"
        },
        {
          "title": "Interpretar",
          "text": "Relacionar evidencias, protagonistas y diferentes duraciones históricas.",
          "tag": "02",
          "icon": "layers"
        },
        {
          "title": "Comparar",
          "text": "Distinguir escuelas historiográficas y criterios de periodización.",
          "tag": "03",
          "icon": "compare"
        }
      ]
    },
    {
      ...
      "cards": [
        {
          "title": "Economía",
          "text": "Producción, intercambio y distribución de recursos.",
          "tag": "",
          "icon": "coin"
        },
        {
          "title": "Sociedad",
          "text": "Grupos, relaciones, desigualdades y vida cotidiana.",
          "tag": "",
          "icon": "people"
        },
        {
          "title": "Política",
          "text": "Poder, instituciones, conflictos y acuerdos.",
          "tag": "",
          "icon": "column"
        },
        {
          "title": "Cultura",
          "text": "Ideas, creencias, saberes y formas de expresión.",
          "tag": "",
          "icon": "book"
        }
      ]
    },
    {
      ...
      "cards": [
        {
          "title": "Pasado",
          "text": "Investigamos experiencias, decisiones y conflictos.",
          "tag": "Comprender",
          "icon": "archive"
        },
        {
          "title": "Presente",
          "text": "Explicamos cómo se formó la sociedad en la que vivimos.",
          "tag": "Interpretar",
          "icon": "people"
        },
        {
          "title": "Futuro",
          "text": "Tomamos decisiones mejor informadas.",
          "tag": "Proyectar",
          "icon": "compass"
        }
      ],
      ...
      "cards": [
        {
          ...
          "text": "Un hecho delimitado: la proclamación de la independencia del Perú.",
          "tag": "Corta duración",
          "icon": "clock"
        },
        {
          "title": "Coyuntura",
          "text": "Un conjunto de procesos relacionados: las campañas de independencia.",
          "tag": "Mediana duración",
          "icon": "layers"
        },
        {
          "title": "Estructura",
          "text": "Relaciones persistentes: la organización social y económica colonial.",
          "tag": "Larga duración",
          "icon": "column"
        }
      ],
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "28 de julio de 1821",
          "text": "Acontecimiento: un acto político situado en una fecha concreta.",
          "tag": "Ver explicación",
          "icon": "clock"
        },
        {
          "title": "Campañas de independencia",
          "text": "Coyuntura: varios años de conflictos, alianzas y cambios políticos.",
          "tag": "Ver explicación",
          "icon": "layers"
        },
        {
          "title": "Jerarquías sociales coloniales",
          "text": "Estructura: relaciones duraderas que no desaparecen en un solo día.",
          "tag": "Ver explicación",
          "icon": "column"
        }
      ],
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Individuos",
          "text": "Gobernantes, dirigentes, pensadores y personas que toman decisiones.",
          "tag": "",
          "icon": "person"
        },
        {
          "title": "Colectividades",
          "text": "Campesinos, trabajadores, comunidades, movimientos y organizaciones.",
          "tag": "",
          "icon": "people"
        }
      ],
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Preguntar",
          "text": "Delimitar qué queremos explicar.",
          "tag": "1",
          "icon": "search"
        },
        {
          "title": "Buscar",
          "text": "Localizar testimonios y restos pertinentes.",
          "tag": "2",
          "icon": "archive"
        },
        {
          "title": "Contrastar",
          "text": "Examinar origen, intención y coincidencias.",
          "tag": "3",
          "icon": "compare"
        },
        {
          "title": "Explicar",
          "text": "Argumentar y reconocer lo que aún ignoramos.",
          "tag": "4",
          "icon": "book"
        }
      ],
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Escritas",
          "text": "Cartas, crónicas y contratos.",
          "tag": "",
          "icon": "book"
        },
        {
          "title": "Arqueológicas",
          "text": "Objetos, construcciones y restos materiales.",
          "tag": "",
          "icon": "vase"
        },
        {
          "title": "Orales",
          "text": "Entrevistas y relatos transmitidos.",
          "tag": "",
          "icon": "speech"
        },
        {
          "title": "Etnológicas",
          "text": "Costumbres y prácticas culturales vigentes.",
          "tag": "",
          "icon": "people"
        },
        {
          "title": "Audiovisuales",
          "text": "Fotografías, películas y grabaciones.",
          "tag": "",
          "icon": "camera"
        }
      ],
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Fuente escrita",
          "text": "Un contrato registra acuerdos, obligaciones y participantes.",
          "tag": "¿Qué dice y quién lo escribió?",
          "icon": "book"
        },
        {
          "title": "Fuente arqueológica",
          "text": "Una vasija informa sobre técnicas, usos e intercambios.",
          "tag": "¿Cómo, dónde y para qué se usó?",
          "icon": "vase"
        }
      ],
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Orales",
          "text": "Una entrevista recoge recuerdos y perspectivas de quien participó.",
          "tag": "Testimonios",
          "icon": "speech"
        },
        {
          "title": "Etnológicas",
          "text": "Una festividad permite estudiar prácticas que siguen vivas.",
          "tag": "Costumbres",
          "icon": "people"
        },
        {
          "title": "Audiovisuales",
          "text": "Una fotografía o un video muestra una selección de lo ocurrido.",
          "tag": "Registros",
          "icon": "camera"
        }
      ],
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Procedencia",
          "text": "¿Quién la produjo, cuándo y en qué circunstancias?",
          "tag": "Origen",
          "icon": "search"
        },
        {
          "title": "Intención",
          "text": "¿Para quién se hizo y qué buscaba comunicar?",
          "tag": "Propósito",
          "icon": "compass"
        },
        {
          "title": "Contraste",
          "text": "¿Qué coincide o discrepa con otras evidencias?",
          "tag": "Comprobación",
          "icon": "compare"
        }
      ],
    ...
    },
    {
      ...
      "rows": [
        [
          "Arqueología",
          "Restos materiales en su contexto.",
          "Viviendas, utensilios y enterramientos."
        ],
        [
          "Antropología",
          "El ser humano y su diversidad biológica y cultural.",
          "Prácticas, relaciones y tradiciones."
        ],
        [
          "Geografía",
          "Territorios y relaciones entre sociedad y ambiente.",
          "Rutas, asentamientos y recursos."
        ],
        [
          "Paleontología",
          "Vida del pasado a partir de fósiles.",
          "Restos y huellas de organismos."
        ],
        [
          "Economía",
          "Producción, distribución y uso de recursos.",
          "Trabajo, intercambios y desigualdad."
        ]
      ],
      "headers": [
        "Ciencia",
    ...
    },
    {
      ...
      "rows": [
        ...
        [
          ...
          "Interpretar una escena pintada."
        ],
        [
          "Numismática",
          "Monedas y medallas.",
          "Examinar una moneda acuñada."
        ],
        [
          "Epigrafía",
          "Inscripciones sobre materiales duraderos.",
          "Estudiar un texto tallado en piedra."
        ],
        [
          "Heráldica",
          "Escudos de armas y blasones.",
          "Interpretar un escudo familiar."
        ]
      ],
      "headers": [
        "Disciplina",
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Preguntas",
          "text": "¿Qué problemas se consideran importantes?",
          "tag": "",
          "icon": "search"
        },
        {
          "title": "Fuentes",
          "text": "¿Qué testimonios se utilizan?",
          "tag": "",
          "icon": "archive"
        },
        {
          "title": "Protagonistas",
          "text": "¿A quiénes se presta atención?",
          "tag": "",
          "icon": "people"
        },
        {
          "title": "Explicaciones",
          "text": "¿Qué factores se destacan?",
          "tag": "",
          "icon": "layers"
        }
      ],
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Grecia",
          "text": "Herodoto reunió relatos; Tucídides analizó conflictos y decisiones humanas.",
          "tag": "Siglo V a. C.",
          "icon": "column"
        },
        {
          "title": "Roma",
          "text": "Julio César y Tito Livio escribieron sobre guerras, poder y trayectoria romana.",
          "tag": "Antigüedad",
          "icon": "book"
        }
      ],
      ...
      "cards": [
        {
          ...
          "text": "Interpretó la trayectoria humana en relación con un plan divino.",
          "tag": "Siglos V–XV",
          "icon": "book"
        },
        {
          "title": "Humanismo",
          "text": "Revaloró los autores clásicos y destacó la acción humana.",
          "tag": "Siglos XIV–XVI",
          "icon": "person"
        }
      ],
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Ilustración",
          "text": "Destacó la razón, la crítica de la autoridad y la idea de progreso.",
          "tag": "Siglo XVIII",
          "icon": "compass"
        },
        {
          "title": "Positivismo y tradición documental",
          "text": "Reforzaron el examen crítico de documentos y el estudio político.",
          "tag": "Siglo XIX",
          "icon": "archive"
        }
      ],
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Marxismo",
          "text": "Estudia relaciones de producción, clases sociales y conflictos.",
          "tag": "Siglos XIX–XX",
          "icon": "people"
        },
        {
          "title": "Annales",
          "text": "Amplía fuentes y problemas; relaciona sociedad, economía, cultura y duraciones.",
          "tag": "Siglo XX",
          "icon": "layers"
        }
      ],
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Prehistoria",
          "text": "Antes de la escritura en cada sociedad.",
          "tag": "Sin una fecha universal",
          "icon": "vase"
        },
        {
          "title": "Antigua",
          "text": "Primeras escrituras y civilizaciones antiguas.",
          "tag": "IV milenio a. C.",
          "icon": "column"
        },
        {
          "title": "Media",
          "text": "Desde la caída del Imperio romano de Occidente.",
          "tag": "476",
          "icon": "archive"
        },
        {
          "title": "Moderna",
          "text": "Desde la toma de Constantinopla.",
          "tag": "1453",
          "icon": "compass"
        },
        {
          "title": "Contemporánea",
          "text": "Desde la Revolución francesa.",
          "tag": "1789",
          "icon": "people"
        }
      ],
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Lo que aporta",
          "text": "Una secuencia convencional para ordenar contenidos y comparar procesos.",
          "tag": "Organización",
          "icon": "layers"
        },
        {
          "title": "Lo que debemos revisar",
          "text": "Suponer que esos cortes explican por igual la historia de todos los pueblos.",
          "tag": "Alcance",
          "icon": "globe"
        }
      ],
      ...
      "cards": [
        {
          ...
          "text": "Trabajo, conocimientos, herramientas y técnicas.",
          "tag": "",
          "icon": "tool"
        },
        {
          "title": "Relaciones de producción",
          "text": "Propiedad, control de recursos y organización del trabajo.",
          "tag": "",
          "icon": "people"
        }
      ],
    ...
    },
    {
      ...
      "rows": [
        [
          "Comunidad primitiva",
          "Cooperación y acceso comunitario a recursos.",
          "Sin clases en el modelo ideal."
        ],
        [
          "Esclavismo",
          "Apropiación del trabajo de personas esclavizadas.",
          "Esclavistas y esclavizados."
        ],
        [
          "Feudalismo",
          "Tierra y vínculos de dependencia campesina.",
          "Señores y campesinos dependientes."
        ],
        [
          "Capitalismo",
          "Capital privado y trabajo asalariado.",
          "Burguesía y trabajadores asalariados."
        ]
      ],
      "headers": [
        "Etapa del modelo",
    ...
    },
    {
      ...
      "cards": [
        {
          "title": "Tradicional",
          "text": "Distingue edades usando hitos políticos y culturales.",
          "tag": "Pregunta: ¿entre qué hitos?",
          "icon": "clock"
        },
        {
          "title": "Materialista",
          "text": "Distingue formas de producción y relaciones sociales.",
          "tag": "Pregunta: ¿cómo se organiza la sociedad?",
          "icon": "people"
        }
      ],
