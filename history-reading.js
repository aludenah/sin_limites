...
const THEORY=SLIDES.filter(s=>!['cover','finish','question'].includes(s.kind)&&s.id!=='s2');
...
const blockTarget=i=>i===0?'chapter-top':i===1?'learning-goals':i===SLIDES.length-1?'chapter-finish':'block-'+SLIDES[i].id;
