window.DIMENSIONAL_CONTENT = {
  ...
  "lessons": [
    ...
    },
    {
      ...
      "body": "<p>Una <strong>magnitud física</strong> es una propiedad de un cuerpo o fenómeno que puede expresarse cuantitativamente mediante un número y una referencia de medida. Medir consiste en compararla con una unidad de la misma naturaleza.</p><div class=\"equation\">\\[\\ell=2\\,\\mathrm m\\qquad\\underbrace{2}_{\\text{valor numérico}}\\quad\\underbrace{\\mathrm m}_{\\text{unidad}}\\]</div><p>La longitud es la magnitud; 2 es su valor numérico; el metro es la unidad. Si escribimos 200 cm, describimos la misma longitud con otra unidad. Una balanza permite medir masa; una regla, longitud; un cronómetro, intervalos de tiempo; una probeta graduada, volumen.</p><h4>Magnitudes fundamentales o base</h4><p>Son las magnitudes elegidas como punto de partida para expresar las demás. El <strong>Sistema Internacional de Unidades (SI)</strong> utiliza siete.</p><div class=\"table-scroll\"><table><thead><tr><th>Magnitud base</th><th>Dimensión</th><th>Unidad SI</th><th>Símbolo</th></tr></thead><tbody><tr><td>Longitud</td><td>\\(L\\)</td><td>metro</td><td>m</td></tr><tr><td>Masa</td><td>\\(M\\)</td><td>kilogramo</td><td>kg</td></tr><tr><td>Tiempo</td><td>\\(T\\)</td><td>segundo</td><td>s</td></tr><tr><td>Temperatura termodinámica</td><td>\\(\\Theta\\)</td><td>kelvin</td><td>K</td></tr><tr><td>Intensidad de corriente eléctrica</td><td>\\(I\\)</td><td>amperio</td><td>A</td></tr><tr><td>Cantidad de sustancia</td><td>\\(N\\)</td><td>mol</td><td>mol</td></tr><tr><td>Intensidad luminosa</td><td>\\(J\\)</td><td>candela</td><td>cd</td></tr></tbody></table></div><p>Los símbolos \\(L,M,T,\\Theta,I,N,J\\) indican dimensiones; no son los símbolos de las unidades. Por ejemplo, \\(M\\) representa la dimensión de masa y kg es el símbolo del kilogramo. El contexto distingue \\(J\\), usado aquí como dimensión luminosa, de J como símbolo del joule.</p><h4>Magnitudes derivadas</h4><p>Se relacionan con las magnitudes base mediante productos, cocientes o potencias. El área se obtiene de dos longitudes; el volumen, de tres; la densidad relaciona masa y volumen; la velocidad relaciona desplazamiento y tiempo.</p><div class=\"table-scroll\"><table><thead><tr><th>Magnitud derivada</th><th>Unidad SI</th><th>Símbolo</th></tr></thead><tbody><tr><td>Área</td><td>metro cuadrado</td><td>m²</td></tr><tr><td>Volumen</td><td>metro cúbico</td><td>m³</td></tr><tr><td>Densidad</td><td>kilogramo por metro cúbico</td><td>kg/m³</td></tr><tr><td>Velocidad</td><td>metro por segundo</td><td>m/s</td></tr><tr><td>Aceleración</td><td>metro por segundo cuadrado</td><td>m/s²</td></tr><tr><td>Fuerza</td><td>newton</td><td>N</td></tr><tr><td>Trabajo y energía</td><td>joule</td><td>J</td></tr><tr><td>Presión</td><td>pascal</td><td>Pa</td></tr><tr><td>Potencia</td><td>watt</td><td>W</td></tr><tr><td>Cantidad de movimiento</td><td>kilogramo metro por segundo</td><td>kg·m/s</td></tr><tr><td>Torque</td><td>newton metro</td><td>N·m</td></tr><tr><td>Carga eléctrica</td><td>coulomb</td><td>C</td></tr><tr><td>Velocidad angular</td><td>radián por segundo</td><td>rad/s</td></tr></tbody></table></div><p>Una fuerza elástica puede medirse en newtons; la velocidad de un automóvil, en metros por segundo. El litro y el mililitro son unidades de volumen utilizadas con frecuencia, aunque la unidad coherente del SI es el metro cúbico.</p>",
      "key": "Fundamental o derivada describe el origen de una magnitud; su unidad debe corresponder a la propiedad que se mide.",
      "examples": [
        {
          "title": "Aplicación 1. Unidades y magnitudes base",
          "question": "Indica si es verdadero o falso: I. El kelvin es unidad de una magnitud fundamental. II. Cantidad de sustancia y masa son la misma magnitud. III. El pascal es unidad de una magnitud fundamental.",
          "steps": [
            "I. <strong>Verdadero.</strong> El kelvin mide temperatura termodinámica, una magnitud base.",
            "II. <strong>Falso.</strong> Masa y cantidad de sustancia son magnitudes diferentes, aunque ambas son base. Sus unidades son kilogramo y mol, respectivamente.",
            "III. <strong>Falso.</strong> El pascal mide presión, una magnitud derivada.",
            "Respuesta: <strong>V, F, F.</strong>"
          ],
          "sourcePage": 6
        }
      ]
