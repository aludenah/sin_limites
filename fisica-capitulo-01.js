...
function render(){
  window.TheoryAudio?.setLesson(user&&P.studyMode&&P.activeTab==='theory'?P.currentItem:null);
  if(!user)return;
...
async function signedIn(u){
  window.TheoryAudio?.setLesson(null);
