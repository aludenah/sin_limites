window.VECTOR_CONTENT = {
  ...
  "lessons": [
    {
      "title": "Magnitudes escalares y vectores",
      "subtitle": "Módulo, dirección y sentido",
      "goal": "Distingue escalares de vectores e interpreta una flecha como una cantidad física.",
      "body": "<p>Una <strong>magnitud escalar</strong> se expresa con un valor y una unidad: una masa de 5 kg o una temperatura de −2 °C. Una <strong>magnitud vectorial</strong> necesita además una orientación, como una fuerza de 20 N hacia el este.</p><p>Representamos un vector con una flecha: \\(\\vec A\\). Su <strong>módulo</strong> \\(A=|\\vec A|\\) es un número no negativo. La <strong>dirección</strong> corresponde a la recta que lo contiene o a una paralela; el <strong>sentido</strong> indica hacia cuál de los dos lados apunta. Por ejemplo, este y oeste comparten dirección horizontal, pero tienen sentidos contrarios.</p><div class=\"table-scroll\"><table><thead><tr><th>Escalares</th><th>Vectoriales</th></tr></thead><tbody><tr><td>Distancia recorrida</td><td>Desplazamiento</td></tr><tr><td>Rapidez</td><td>Velocidad</td></tr><tr><td>Masa, tiempo y temperatura</td><td>Fuerza y aceleración</td></tr></tbody></table></div><p>El desplazamiento une la posición inicial con la final y no depende del camino. La distancia sí cuenta todo el recorrido. La rapidez es el módulo de la velocidad: decir «20 m/s» no especifica por sí solo un vector velocidad.</p><h3>Iguales, opuestos y nulos</h3><ul><li>Dos vectores libres son iguales si tienen igual módulo, dirección y sentido, aunque se dibujen en lugares diferentes.</li><li>El opuesto \\(-\\vec A\\) conserva módulo y dirección, pero invierte el sentido.</li><li>El vector nulo \\(\\vec 0\\) tiene módulo cero y no tiene una dirección definida.</li></ul><p>En este capítulo operamos principalmente con <strong>vectores libres</strong>, que podemos trasladar paralelamente. En fuerzas aplicadas a un cuerpo también importa dónde actúan; lo estudiaremos en estática.</p><h3>Multiplicar por un escalar</h3><div class=\"equation\">\\[|k\\vec A|=|k|\\,|\\vec A|\\]</div><p>Si \\(k>0\\), se conserva el sentido; si \\(k<0\\), se invierte; si \\(k=0\\), obtenemos el vector nulo. Una componente negativa indica orientación, no un módulo negativo.</p>",
      "key": "El vector contiene orientación; su módulo es escalar. Un signo negativo cambia el sentido, no hace negativo el módulo.",
      "examples": [
        {
          "title": "Caminar y regresar",
          "question": "Una estudiante camina 6 m al este y después 2 m al oeste. Halla la distancia y el desplazamiento.",
          "steps": [
            "La distancia suma los tramos: 6 + 2 = 8 m.",
            "Toma el este como positivo: el cambio de posición es +6 − 2 = +4 m.",
            "El desplazamiento es 4 m al este; su módulo es 4 m. No es igual a los 8 m recorridos."
          ]
        },
        {
          "title": "Un múltiplo negativo",
          "question": "\\(\\vec A\\) tiene módulo 4 N y apunta al norte. Describe \\(-3\\vec A\\).",
          "steps": [
            "El módulo es \\(|-3|\\cdot4=12\\,\\mathrm N\\).",
            "El signo negativo invierte el sentido: apunta al sur.",
            "La dirección sigue siendo norte-sur."
          ]
        }
      ],
      "quiz": [
        {
          "id": "u1a",
          "prompt": "¿Cuál es una magnitud vectorial?",
          "options": [
            "Masa",
            "Tiempo",
            "Aceleración",
          ...
          "answer": 2,
          "solution": "La aceleración tiene módulo y orientación; las otras opciones son escalares.",
          "level": "Básico"
        },
        {
          "id": "u1b",
          "prompt": "Si \\(\\vec A\\) mide 5 m y apunta al este, ¿cómo es \\(-2\\vec A\\)?",
          "options": [
            "10 m al este",
            "10 m al oeste",
            "−10 m al oeste",
          ...
          "answer": 1,
          "solution": "El módulo es |−2| × 5 = 10 m y el sentido se invierte hacia el oeste.",
          "level": "Básico"
        }
      ]
    },
      ...
      "examples": [
        {
          ...
          "steps": [
            ...
            "La resultante apunta al noreste. Su módulo no es 21 N: eso solo ocurriría si ambas fuerzas tuvieran el mismo sentido."
          ]
        },
        {
  ...
  "exam": [
    {
      ...
      "options": [
        "Tener el mismo módulo, aunque apunten en sentidos contrarios",
        "Tener la misma dirección, aunque sus módulos sean distintos",
        "Tener igual módulo, dirección y sentido",
        "Tener siempre el mismo punto de aplicación",
        "Tener componentes con igual valor absoluto"
      ],
      "answer": 2,
      "solution": "La igualdad de vectores libres requiere módulo, dirección y sentido iguales. El lugar donde se dibujan puede cambiar.",
      "level": "Básico"
    },
    {
      "id": "e2",
    ...
    },
    {
      ...
      "answer": 1,
      "solution": "La resultante mínima se obtiene con sentidos opuestos: Rmín = |8 − 5| = 3 unidades.",
      "level": "Básico"
    },
    {
      "id": "e5",
