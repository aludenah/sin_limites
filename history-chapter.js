...
async function signedIn(u){
  ...
  const navigation={catalogVersion:2,lastCourseId:12,lastCourseName:'Historia Universal',lastTopicIndex:CHAPTER_NUMBER-1,lastChapterNumber:CHAPTER_NUMBER,lastChapterName:CONTENT.title};
  try{localStorage.setItem('academia-sm-state',JSON.stringify({catalogVersion:2,activeCourseId:12,activeTopicIndex:CHAPTER_NUMBER-1,activeTopicName:CONTENT.title}));}catch{}
